...
export default {
  ...
  methods: {
    load () {
      const {BMapOffline, map, points, strokeColor, strokeWeight, strokeOpacity, strokeStyle, editing, massClear, clicking} = this
      const overlay = new CurveLine(points.map(item => createPoint(BMapOffline, item)), {
        strokeColor,
        strokeWeight,
        strokeOpacity,
        strokeStyle,
