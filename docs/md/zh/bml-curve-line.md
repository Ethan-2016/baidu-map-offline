...
```html
<template>
<baidu-map-offline class="map" :center="{lng: 118.454, lat: 32.955}" :zoom="5">
  <bml-curve-line :points="points" :editing="true" @lineupdate="update"></bml-curve-line>
</baidu-map-offline>
</template>

<script>
import {BmlCurveLine} from 'vue-baidu-map-offline'
export default {
  components: {
    BmlCurveLine
  },
...
<doc-preview>
  <baidu-map-offline class="map" :center="{lng: 118.454, lat: 32.955}" :zoom="5" :scroll-wheel-zoom="true">
    <bml-curve-line :points="points" :editing="true" @lineupdate="update"></bml-curve-line>
  </baidu-map-offline>
  <md-table>
    <md-table-header>
